...
public class Ex01 {
    ...
    void test1() {
        // 반복문 - 성능 좋음
        long stime = System.nanoTime(); // 공통 기능 : 시간 측정
        ImplCalculator cal1 = new ImplCalculator();
        long result1 = cal1.factorial(10L); // 핵심 기능 : 연산
        System.out.printf("cal1: %d%n", result1);
        long etime = System.nanoTime(); // 공통 기능 : 시간 측정
        System.out.printf("cal1 걸린시간: %d%n", etime - stime);

        // 재귀 방식 - 성능 좋지 않음
        stime = System.nanoTime(); // 공통 기능 : 시간 측정
        RecCalculator cal2 = new RecCalculator();
        long result2 = cal2.factorial(10L); // 핵심 기능 : 연산
        System.out.printf("cal2: %d%n", result2);
        etime = System.nanoTime(); // 공통 기능 : 시간 측정
